...
async function adminUsers(req,res){
  const t=auth(req);
  if(!t || t.role!=='owner') return fail(res,403,'Somente o dono pode gerenciar administradores.');
  await db();
...
async function adminRoles(req,res){
  const t=auth(req); if(!t || t.role!=='owner') return fail(res,403,'Somente o dono pode gerenciar administradores.');
